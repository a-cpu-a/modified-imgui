...
#define IM_SAT_INT8(_VAL)               ImClamp(_VAL,0,0xFF)                                    // Saturated, always output 0..255
...
template<typename T> static inline T ImLerpPremultiplied(T a, T b, float t)     { return (T)(b + (a * ((T)(1) - ((T)t)))); }
