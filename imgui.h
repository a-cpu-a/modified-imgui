...
namespace ImGui
{
    ...
    // Styles
    IMGUI_API void          PremultiplyStyleColors(ImVec4* colors);     // premultiply your colors
    IMGUI_API void          GammaCorrectStyleColors(ImVec4* colors);    // gamma correct your colors
